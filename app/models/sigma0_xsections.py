...
def sig0v_F(s, mq, Mmed, mx, gr, gl, gx, Nf):  ## integrated total cross section FERMION \sigma_0 (ee -> Z' -> XX)
    ...
    if s < 4*(mx**2): ##Define the correct physical domain for s channel 
        ...
        totalCS = np.sqrt(s)* np.sqrt(-4*mq**2 + s)*(gl**2*(4*M**4*mq**2*mx**2*(glx**2 - 3*glx*grx + grx**2) - M**2*s*(M**2*mq**2*(glx**2 - 6*glx*grx + grx**2) + mx**2*(M**2*(glx**2 + grx**2) + 6*mq**2*(glx - grx)**2)) + s**2*(M**4*(glx**2 + grx**2) + 3*mq**2*mx**2*(glx - grx)**2)) + 6*gl*gr*mx**2*(-2*M**4*mq**2*(glx**2 - 4*glx*grx + grx**2) + M**4*s*(glx**2 + grx**2) + 2*M**2*mq**2*s*(glx - grx)**2 - mq**2*s**2*(glx - grx)**2) + gr**2*(4*M**4*mq**2*mx**2*(glx**2 - 3*glx*grx + grx**2) - M**2*s*(M**2*mq**2*(glx**2 - 6*glx*grx + grx**2) + mx**2*(M**2*(glx**2 + grx**2) + 6*mq**2*(glx - grx)**2)) + s**2*(M**4*(glx**2 + grx**2) + 3*mq**2*mx**2*(glx - grx)**2)))/(48*np.pi*M**4*s**2*(Gamma**2*M**2 + (M**2 - s)**2))
        #Try this
        #totalCS = np.sqrt((-4*mq**2 + s)*(-4*mx**2 + s))*(gl**2*(glx**2*(M**4*(mq**2*(4*mx**2 - s) + s*(-mx**2 + s)) - 6*M**2*mq**2*mx**2*s + 3*mq**2*mx**2*s**2) - 6*glx*grx*mq**2*(M**4*(2*mx**2 - s) - 2*M**2*mx**2*s + mx**2*s**2) + grx**2*(M**4*(mq**2*(4*mx**2 - s) + s*(-mx**2 + s)) - 6*M**2*mq**2*mx**2*s + 3*mq**2*mx**2*s**2)) - 6*gl*gr*mx**2*(glx**2*(M**4*(2*mq**2 - s) - 2*M**2*mq**2*s + mq**2*s**2) - 2*glx*grx*mq**2*(4*M**4 - 2*M**2*s + s**2) + grx**2*(M**4*(2*mq**2 - s) - 2*M**2*mq**2*s + mq**2*s**2)) + gr**2*(glx**2*(M**4*(mq**2*(4*mx**2 - s) + s*(-mx**2 + s)) - 6*M**2*mq**2*mx**2*s + 3*mq**2*mx**2*s**2) - 6*glx*grx*mq**2*(M**4*(2*mx**2 - s) - 2*M**2*mx**2*s + mx**2*s**2) + grx**2*(M**4*(mq**2*(4*mx**2 - s) + s*(-mx**2 + s)) - 6*M**2*mq**2*mx**2*s + 3*mq**2*mx**2*s**2)))/(96*np.pi*M**4*s**2*(M**4 + M**2*(Gamma**2 - 2*s) + s**2))
    return totalCS
# ------------------------------------------------------------------------------
...
def sig0v_S(s, mq, Mmed, mx, gr, gl, gx, Nf):    ## integrated total cross section \sigma_0 (ee -> Z' -> XX)
    ...
    if s < 4*(mx**2): ##Define the correct physical domain for s channel 
        ...
        #totalCS = gxs**2*np.sqrt(-4*mq**2 + s)*( (np.sqrt((-4*mx**2 + s)))*(-4*mx**2 + s))*(-mq**2*(gl**2 - 6*gl*gr + gr**2) + s*(gl**2 + gr**2))/(96*np.pi*s**2*(Gamma**2*M**2 + (M**2 - s)**2))
        #New try
        totalCS = -gxs**2*(np.sqrt(s)/2)*np.sqrt(-(4*mq**2 - s))*(-4*mx**2 + s)*(gl**2*(mq**2 - s) - 6*gl*gr*mq**2 + gr**2*(mq**2 - s))/(192*np.pi*s**2*(M**4 + M**2*(Gamma**2 - 2*s) + s**2))
        return totalCS
...
def sig0v_V(s, mq, Mmed, mx, gr, gl, gx, Nf):
    ...
    result = (1/192)*(np.sqrt(s)/2)*g_dm**2*(g_l**2 + g_r**2)*(-48*M_med**2*m_f**6 - 68*M_med**2*m_f**4*s + 16*M_med**2*m_f**2*s**2 + M_med**2*s**3 + 192*m_f**4*s**2 - 96*m_f**2*s**3 + 12*s**4)/(M_med**2*m_f**4*sqrt(s)*(Gamma**2*M_med**2 + M_med**4 - 2*M_med**2*s + s**2))
    return result
