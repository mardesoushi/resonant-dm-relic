...
#SM COUPLINGS
ge = 0.30282212088  #*cp.pi*4                  #  ge = e (for h = c = 1 ref. Grif)  // alphaQED = e^2 / 4*Pi 
alph =  ge**2 / (4*cp.pi)      # (1/137)    # QED coupling constant

thetaW =  28.759 * (cp.pi/180)  ## Weinberg angle
cv = (-1/2) + (2 * (cp.sin(thetaW)**2))
ca = -1/2
gz = ge / (cp.sin(thetaW) * cp.cos(thetaW))
